...
class ProcessImplPatch(object):
    ...
    def script(self):
        """
        Gets the script of this ProcessImplPatch.
        Script to execute to run the process on the cluster

        :return: The script of this ProcessImplPatch.
        :rtype: str
        """
        return self._script
    ...
    def script(self, script):
        """
        Sets the script of this ProcessImplPatch.
        Script to execute to run the process on the cluster

        :param script: The script of this ProcessImplPatch.
        :type: str
        """
