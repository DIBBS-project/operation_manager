...
class ProcessDef(object):
    ...
    def logo_url(self):
        """
        Gets the logo_url of this ProcessDef.
        URL to a logo image

        :return: The logo_url of this ProcessDef.
        :rtype: str
        """
    ...
    def logo_url(self, logo_url):
        """
        Sets the logo_url of this ProcessDef.
        URL to a logo image

        :param logo_url: The logo_url of this ProcessDef.
        :type: str
        """
    ...
    def description(self):
        """
        Gets the description of this ProcessDef.
        Textual description of the semantics of the process

        :return: The description of this ProcessDef.
        :rtype: str
        """
    ...
    def description(self, description):
        """
        Sets the description of this ProcessDef.
        Textual description of the semantics of the process

        :param description: The description of this ProcessDef.
        :type: str
        """
    ...
    def string_parameters(self):
        """
        Gets the string_parameters of this ProcessDef.
        JSON-formatted array (treated as a set) giving the list of string parameters of the process

        :return: The string_parameters of this ProcessDef.
        :rtype: str
        """
    ...
    def string_parameters(self, string_parameters):
        """
        Sets the string_parameters of this ProcessDef.
        JSON-formatted array (treated as a set) giving the list of string parameters of the process

        :param string_parameters: The string_parameters of this ProcessDef.
        :type: str
        """
    ...
    def file_parameters(self):
        """
        Gets the file_parameters of this ProcessDef.
        JSON-formatted array (treated as a set) giving the list of file parameters of the process

        :return: The file_parameters of this ProcessDef.
        :rtype: str
        """
    ...
    def file_parameters(self, file_parameters):
        """
        Sets the file_parameters of this ProcessDef.
        JSON-formatted array (treated as a set) giving the list of file parameters of the process

        :param file_parameters: The file_parameters of this ProcessDef.
        :type: str
        """
