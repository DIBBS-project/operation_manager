...
class ProcessDefPost(object):
    ...
    def executable(self):
        """
        Gets the executable of this ProcessDefPost.
        Path to the executable

        :return: The executable of this ProcessDefPost.
        :rtype: str
        """
    ...
    def executable(self, executable):
        """
        Sets the executable of this ProcessDefPost.
        Path to the executable

        :param executable: The executable of this ProcessDefPost.
        :type: str
        """
    ...
    def cwd(self):
        """
        Gets the cwd of this ProcessDefPost.
        Working directory to be in when ruing the process

        :return: The cwd of this ProcessDefPost.
        :rtype: str
        """
        return self._cwd
    ...
    def cwd(self, cwd):
        """
        Sets the cwd of this ProcessDefPost.
        Working directory to be in when ruing the process

        :param cwd: The cwd of this ProcessDefPost.
        :type: str
        """
    ...
    def environment(self):
        """
        Gets the environment of this ProcessDefPost.
        JSON-formatted dictonary to give values to environment variables (can contain parameters)

        :return: The environment of this ProcessDefPost.
        :rtype: str
        """
    ...
    def environment(self, environment):
        """
        Sets the environment of this ProcessDefPost.
        JSON-formatted dictonary to give values to environment variables (can contain parameters)

        :param environment: The environment of this ProcessDefPost.
        :type: str
        """
    ...
    def argv(self, argv):
        """
        Sets the argv of this ProcessDefPost.
        JSON-formatted array being a list of arguments to give to the executable (can contain parameters)

        :param argv: The argv of this ProcessDefPost.
        :type: str
        """
    ...
    def output_type(self):
        """
        Gets the output_type of this ProcessDefPost.
        type of output (e.g. file, stream)

        :return: The output_type of this ProcessDefPost.
        :rtype: str
        """
    ...
    def output_type(self, output_type):
        """
        Sets the output_type of this ProcessDefPost.
        type of output (e.g. file, stream)

        :param output_type: The output_type of this ProcessDefPost.
        :type: str
        """
    ...
    def output_parameters(self):
        """
        Gets the output_parameters of this ProcessDefPost.
        JSON-formatted dictionary containing parameters regarding the output (depending on the output type)

        :return: The output_parameters of this ProcessDefPost.
        :rtype: str
        """
    ...
    def output_parameters(self, output_parameters):
        """
        Sets the output_parameters of this ProcessDefPost.
        JSON-formatted dictionary containing parameters regarding the output (depending on the output type)

        :param output_parameters: The output_parameters of this ProcessDefPost.
        :type: str
        """
